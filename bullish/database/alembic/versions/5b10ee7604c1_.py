...
def upgrade() -> None:
    ...
    with op.batch_alter_table('analysis', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_analysis_price_above_sma_50', ['price_above_sma_50'], unique=False)
        batch_op.create_index('ix_analysis_sma_50_above_sma_200', ['sma_50_above_sma_200'], unique=False)
