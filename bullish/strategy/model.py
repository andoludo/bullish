...
import pandas as pd
from bearish.scrapers.model import Ticker  # type: ignore
...
class TickerAnalysis(Ticker):  # type: ignore
    def get_price(self) -> Optional[pd.DataFrame]:
...
class Backtest(BaseModel):
    ...
    def play(
        self, name: str = "test", time_span: int = 0, plot: bool = True
    ) -> pd.DataFrame:
